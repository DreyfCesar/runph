...
La carpeta `config/` almacena los archivos de configuración que emplean algunos componentes.

## Archivos disponibles

- `commands`: declara la lista de comandos para la aplicación symfony
